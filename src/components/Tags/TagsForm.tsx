...
const NewTagButton = ({ onClick, isPrimary }: { onClick: () => void; isPrimary: boolean }) => {
  ...
  return (
    <Button color={isPrimary ? color : 'black'} onClick={onClick} data-testid="new-tag-button">
      <FaPlusCircle />
      &nbsp;New Tag
    </Button>
  );
...
const EditTagButton = ({ onClick, isPrimary }: { onClick: () => void; isPrimary: boolean }) => {
  ...
  return (
    <Button color={isPrimary ? color : 'black'} onClick={onClick} data-testid="edit-tag-button">
      <FaEdit />
      &nbsp;Edit Tag
    </Button>
  );
